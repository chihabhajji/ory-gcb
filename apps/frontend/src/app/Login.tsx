...
function Login() {
    ...
    useEffect(() => {
        ...
        frontEndOryApi.createBrowserLoginFlow({ returnTo: 'http://127.0.0.1:4200/' })
    ...
    if (!action) return <h1>Something went wrong when contacting the Ory client <span role={'img'} aria-label={'idk man'}>🤷‍♀️ </span></h1>
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if(!action?.id) return console.error('No action id');
